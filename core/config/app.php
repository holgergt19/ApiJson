...
return [
    ...
    'App' => [
        ...
        'Cors' => [
            'allowOrigin' => ['*'], // Permite todas las solicitudes de origen cruzado
            'allowMethods' => ['GET', 'POST', 'PUT', 'DELETE'], // Permite estos métodos HTTP
            'allowHeaders' => ['Content-Type'], // Permite estos encabezados
            'exposeHeaders' => [], // Encabezados expuestos
            'maxAge' => 300, // Tiempo de almacenamiento en caché de la pre-vuelo (preflight)
            'allowCredentials' => false, // Permitir credenciales (cookies, autenticación de origen cruzado, etc.)
        ],
    ],
